...
**Participants** (minimum 3, ideal 8-15). Respond to prompts, review candidates, rate them, and vote. They need domain knowledge relevant to the topic but no process expertise. They don't need to install anything or learn any tools. They just reply to emails.
